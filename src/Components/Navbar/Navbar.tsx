...
<nav className="bg-white px-2 sm:px-4 py-2.5 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="https://www.typescriptlang.org" className="flex items-center">
    <img className="p-1 w-10 h-10 rounded-full ring-2 -ml-10 mr-4 ring-gray-300 dark:ring-gray-500" src="https://avatars.githubusercontent.com/u/98229954?v=4" alt="Bordered avatar"/>
      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Typescript_logo_2020.svg/1200px-Typescript_logo_2020.svg.png" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo"/>
      <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">I'm learning Typescript</span>
  </a>
